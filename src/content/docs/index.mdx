...
<CardGrid stagger>
	<LinkCard
		...
		description="System overview, data flows, multi-tenancy design, and integration plans."
	/>
	<LinkCard
		title="Guides"
		href="./guides/environments/"
		description="Development setup, deployment, CI/CD, real-time integration, printer system, telephony agent, auth, and testing."
	/>
	<LinkCard
		title="Reference"
		href="./reference/auth-system/"
		description="Architecture design document and authentication system reference."
	/>
</CardGrid>
